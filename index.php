        ...
        <form>
          <div class="row align-items-end">
            ...
            <div class="col-lg-2 mb-3">
              <label class="form-label" style="font-weight:500;">childerns</label>
              <select class="form-select shadow-none">
                <option selected>2 childrens</option>
            ...
            <div class="col-lg-1 mb-lg-3 mt-2">
              <button type="submit" class="btn btn-primary shadow-none custom-bg">Search</button>
            </div>
          </div>
        </form>
      </div>
        ...
        <div class="card-body">
          ...
          <div class="rating mb-4">
            ...
            <div class="d-flex justify-content-evenly mb-2">
              <a href="#" class="btn btn-primary text-whitem custom-bg shadow-none">Book Now</a>
              <a href="#" class="btn btn-primary btn-outline-dark shadow-none">More details </a>
            </div>
        </div>
      </div>
    </div>
...
<div class="container">
  ...
  <div class="col-lg-12 text-center mt-5">
    <a href="#" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-non">More Facilities</a>
  </div>
  </div>
</div>
...
<div class="container mt-5">
  ...
  <div class="swiper swiper-testimonial">
    ...
    <div class="col-lg-12 text-center mt-5">
      <a href="#" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-non">Know More</a>
    </div>
</div>
  ...
  <div class="row">
    ...
    <div class="col-lg-4 col-md-4">
      ...
      <div class="bg-white p-4 rounded mb-4">
        <h5>Call us</h5>
        <a href="tel:+ 923355392030" class="d-inline-block mb-2 text-decoration-none text-dark">
          <i class="bi bi-telephone-outbound-fill"></i>+923355392030</a>
      </div>
