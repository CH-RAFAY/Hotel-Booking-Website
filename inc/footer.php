...
<div class="container-fluid bg-white mt-5">
  <div class="row">
    <div class="col-lg-4 p-4">
      <h3 class="h-font fw-bold fs-3 mb-2">RestRiser</h3>
    ...
    <div class="col-lg-4 p-4">
      ...
      <a href="#" class="d-inline-block text-dark text text-decoration-none mb-2">
      ...
      <a href="#" class="d-inline-block text-dark text text-decoration-none">
...
<h6 class="text-center bg-dark text-white p-3 m-0"> RestRiser is part of Booking Holdings Inc., the world leader in online travel and related services.
Copyright © 1996–2025 RestRiser™. All rights reserved.
</h6>
